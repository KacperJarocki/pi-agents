...
ADAPTIVE_CONTAMINATION_MAX = float(os.getenv("ADAPTIVE_CONTAMINATION_MAX", "0.01"))
ADAPTIVE_CONTAMINATION_TARGET_BUCKETS = float(os.getenv("ADAPTIVE_CONTAMINATION_TARGET_BUCKETS", "1.0"))
ISOLATION_FOREST_THRESHOLD_MULTIPLIER = float(os.getenv("ISOLATION_FOREST_THRESHOLD_MULTIPLIER", "1.0"))
ISOLATION_FOREST_THRESHOLD_MAX = float(os.getenv("ISOLATION_FOREST_THRESHOLD_MAX", "0.01"))
