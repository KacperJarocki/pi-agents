...
class TestGatewayApiRoutes(unittest.TestCase):
    ...
    def test_device_detail_routes_exist(self):
        ...
        self.assertIn('@router.get("/{device_id}/analysis-export"', router_src)
        self.assertIn('@router.get("/{device_id}/model-comparison"', router_src)
        self.assertIn("get_model_comparison", router_src)
        self.assertIn("analysis_export", router_src)
        self.assertIn("include_replay", router_src)
    ...
    def test_model_version_services_exist(self):
        ...
        self.assertIn("analysis_export", replay)
        self.assertIn("feature_columns", replay)
        self.assertIn("model_replay", replay)
